          ...
          <table id="ListEducation" class="table table-bordered table-striped" style="width:100%;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{!! $Category->slug  !!}</td>
                <td>
                  <a href="{{ route('admin.education.getEdit',$Category->id) }}" class="Modal   edit" data-catalog="{!!$Category->id!!}" > <i class="fa fa-edit" ></i> </a>
                  <button type="button" class="Modal eye" > <i class="fa fa-eye"  ></i> </button>
                  <button type="button" class="Modal trash" data-catalog="{!!$Category->id!!}" data-toggle="modal"  data-target="#ModalDelete"  > <i class="fa fa-trash" ></i> </button>
                </td>
              </tr>
              @endforeach
            </tbody>
