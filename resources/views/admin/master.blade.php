      ...
      <ul class="dropdown-menu">
        ...
        <li class="user-footer">
          ...
          <div class="pull-right">
            <a href="{{ route('admin.logout.PostLogout')}}" class="btn btn-default btn-flat">Sign out</a>
          </div>
        </li>
      </ul>
    </li>
...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li>
        <a href="{{ route('admin.education.getList')}}">
          <i class="fa fa-home"></i> <span>Học Vấn </span>
        </a>
      </li>
      <li>
        <a href="{{ route('admin.experience.getList')}}">
          <i class="fa fa-home"></i> <span>Kinh Nghiệm</span>
        </a>
      </li>
      <li>
        <a href="#">
          <i class="fa fa-home"></i> <span>Info</span>
        </a>
      </li>
      <li class="treeview">
        <a href="#">
          <i class="fa fa-edit"></i> <span>Kỹ Năng</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> Kỹ Năng Cứng</a></li>
          <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Kỹ Năng Mềm</a></li>
        </ul>
      </li>
      <li>
        <a href="{{ route('admin.project.getList')}}">
          <i class="fa fa-home"></i> <span>Dự Án</span>
        </a>
      </li>
      <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li><a href="pages/examples/invoice.html"><i class="fa fa-circle-o"></i>Bài Viết</a></li>
          <li><a href="{{ route('admin.categories.getList')}}"><i class="fa fa-circle-o"></i>Thể Loại</a></li>
          <li><a href="pages/examples/invoice.html"><i class="fa fa-circle-o"></i>Tags</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
          <i class="fa fa-share"></i> <span>Liên Hệ</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
