...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Thêm Mới Dự Án Đã Hoàn Thành </h3>
      </div>
      <div class="col-md-12">
    ...
    <form action="{{ route('admin.project.postCreate')}}" method="POST" enctype="multipart/form-data" >
